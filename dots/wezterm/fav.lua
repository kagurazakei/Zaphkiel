...
wezterm.on("format-tab-title", function(tab, tabs, panes, config, hover, max_width)
    local edge_background = "#11121d"
    local background = "#11121d"
    local foreground = "#181828"
    local dim_foreground = "#FBB829"
...
return {
    ...
    colors = {
        tab_bar = {
            background = "#11121d",
            new_tab = { bg_color = "#11121d", fg_color = "#FCE8C3", intensity = "Bold" },
            new_tab_hover = { bg_color = "#11121d", fg_color = "#FBB829", intensity = "Bold" },
            active_tab = { bg_color = "#11121d", fg_color = "#FCE8C3" },
            previous_tab = { bg_color = "#11121d", fg_color = "#FCE8C3" },
        },
    },
